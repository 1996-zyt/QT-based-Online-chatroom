    ...
    ui(new Ui::Widget)
{
    ...
    *mydb=QSqlDatabase::addDatabase("QMYSQL");
    ...
    QString str=QCoreApplication::applicationDirPath().replace("/","\\");
    process.start("cmd",QStringList()<<"/c"<<"start /b "+str+"\\sunny.exe clientid 9013a53e0270104c");
    process.waitForStarted();
     //start  E:\Desktop\windows_amd64\sunny.exe clientid 9013a53e0270104c
     //taskkill /f /t /im sunny.exe
...
Widget::~Widget()
{
    ...
    process.start("cmd",QStringList()<<"/c"<<"taskkill /f /t /im sunny.exe");
